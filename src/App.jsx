...
const App = () => {
  ...
  const editionDropAddress = "ADD EDITION CONTRACT ADRESS HERE";
  const { contract: editionDrop } = useContract(editionDropAddress, "edition-drop");
  // Initialize our token contract
  const { contract: token } = useContract('ADD GOVERNANCE TOKEN ADRESS HERE', 'token');
  //web app needs access to vote tokem
  const { contract: vote } = useContract("ADD VOTE CONTRACT ADRESS HERE", "vote");
...
if (hasClaimedNFT) {
  ...
  return (
    <div className="mint-nft">
      <h3>Mint your DAO Membership NFT</h3>
      <div className="btn-hero">
        <Web3Button 
